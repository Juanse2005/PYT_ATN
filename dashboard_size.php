    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <table class="table table-bordered">
            ...
            foreach ($db->query($sql) as $row) {
                ...
                echo '<td>' . '<a class="btn btn-danger" href="vcrud_delete_size.php?id=' . $row["id_talla"] . '"> Eliminar </a>' . '</td>';
                echo '</tr>';
            }
            ?>
        </table>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="login-offcanvasRight"
            ...
            <div class="offcanvas-header">
                <h5 class="offcanvas-title" id="offcanvasRightLabel">Agregar talla</h5>
                <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
            </div>
            <div class="offcanvas-body">
                <form name="agregar" action="vcrud_add_size.php" method="post">
                    <div class="mb-3">
                        <label class="form-label">Tipo de producto</label>
                        <input type="text" class="form-control" name="tipo_producto" required>
                        <label class="form-label">Talla</label>
                        <input type="text" class="form-control" name="talla_nombre" required>
