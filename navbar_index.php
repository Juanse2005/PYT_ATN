...
<nav class="navbar navbar-expand-lg bg-light justify-content-between fixed-top">
    ...
    <div class="collapse navbar-collapse">
        <form class="d-flex" action="products.php" method="post">
            <input class="form-control-nav" type="search" name="search_query" placeholder="Buscar..."
                aria-label="Search">
        </form>
    </div>
    <!--Carrito de compras-->
    <div class="collapse navbar-collapse">
        <ul class="navbar-nav me-auto my-2 my-lg-0 " style="--bs-scroll-height: 100px;">
            <li class="nav-item">
                <a href="" data-bs-toggle="offcanvas" data-bs-target="#offcanvas-shopping-cart"
                    aria-controls="offcanvasRight"><img src="img-shopping.png" height="50"></a>
            </li>
            <!--Categorias-->
            <li class="nav-item">
                <a class="nav-link active" href="#" data-bs-toggle="offcanvas" data-bs-target="#offcanvas-categories"
            ...
            <li class="nav-item">
                <a class="nav-link active" href="" data-bs-toggle="offcanvas" data-bs-target="#offcanvas-register"
                    aria-controls="offcanvasRight">
                    Crear cuenta</a>
            </li>
            <!--Formulario de inicio de sesion-->
            <li class="nav-item">
                <a class="nav-link active" href="#" data-bs-toggle="offcanvas" data-bs-target="#offcanvas-login"
                    aria-controls="offcanvasRight">Iniciar sesion</a>
            </li>
        </ul>
    </div>
</nav>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvas-shopping-cart" aria-labelledby="offcanvasRightLabel">
    ...
    <div class="offcanvas-body">
        ...
        <a href='payment.php' class="btn btn-primary mt-3">Ir a la pasarela de pago</a>
    </div>
</div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="mb-3 form-check">
                    ...
                    <a href="terms_&_conditions.php" class="form-check-label" for="exampleCheck1" required>Acepto los
                ...
                <div class="d-grid gap-2 col-6 mx-auto">
                    ...
                    <a class="text-center" href="" data-bs-toggle="offcanvas" data-bs-target="#offcanvas-login"
                        aria-controls="offcanvasRight">¿Ya
                ...
                <div class="modal-body">
                    <form name="login" action="login_validate.php" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control" name="password" required>
                            <div id="emailHelp" class="form-text">Recuerda nunca compartir tu correo y/o ontraseña con
                                otras personas.</div>
                        </div>
