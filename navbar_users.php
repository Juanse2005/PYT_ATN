        ...
        <ul class="navbar-nav me-auto my-2 my-lg-0 " style="--bs-scroll-height: 100px;">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="dashboard.php">
                    <?php
                    // Verificar si hay una sesión iniciada y si existe el nombre de usuario en la sesión
                    if (isset($_SESSION['email'])) {
                        echo $_SESSION['email']; // Muestra el nombre de usuario
                    } else {
                        echo "Administrar"; // Si no hay sesión iniciada, muestra "Administrar"
                    }
                    ?>
                </a>
            </li>
